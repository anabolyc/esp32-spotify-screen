...
SpotifyApi::SpotifyApi(SpotifyUI *_ui, uint8_t port)
{
 ...
 * @param event_type
 */
void SpotifyApi::eventsSendLog(const char *logData, EventsLogTypes type)
{
    if (!send_events)
        return;
 ...
 * @param payload
 */
void SpotifyApi::eventsSendInfo(const char *msg, const char *payload)
{
    if (!send_events)
        return;
 ...
 * @param payload
 */
void SpotifyApi::eventsSendError(int code, const char *msg, const char *payload)
{
    if (!send_events)
        return;
...
void SpotifyApi::Init()
{
    ...
    ESP_LOGD(TAG, "refresh_token = %s", refresh_token);
}

bool SpotifyApi::HaveRefreshToken()
{
    return refresh_token != "";
}

void SpotifyApi::SetState(SptfActions newstate)
{
    this->State = newstate;
}
 ...
 */
void SpotifyApi::CurrentlyPlaying()
{
 ...
 */
void SpotifyApi::GetToken(const String &code, GrantTypes grant_type)
{
 ...
 * @return
 */
HTTP_response_t SpotifyApi::ApiRequest(const char *method, const char *endpoint, const char *content)
{
 ...
 * @param url
 */
void SpotifyApi::DisplayAlbumArt(String url)
{
 ...
 */
void SpotifyApi::deleteRefreshToken()
{
 ...
 * @return String
 */
String SpotifyApi::readRefreshToken()
{
    String tok;
    tok.reserve(150);
 ...
 */
void SpotifyApi::writeRefreshToken()
{
    ESP_LOGD(TAG, "\n> [%d] writeRefreshToken()\n", micros());
 ...
 * @return
 */
HTTP_response_t SpotifyApi::httpRequest(const char *host, uint16_t port, const char *headers, const char *content)
{
